...
class GlossaryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListTerms = channel.unary_unary(
            ...
            response_deserializer=glossary__pb2.TermNames.FromString,
            _registered_method=True,
        )
        self.GetTerm = channel.unary_unary(
            "/glossary.GlossaryService/GetTerm",
            request_serializer=glossary__pb2.TermNameRequest.SerializeToString,
        ...
        self.CreateTerm = channel.unary_unary(
            ...
            request_serializer=glossary__pb2.TermCreateRequest.SerializeToString,
            response_deserializer=glossary__pb2.TermResponse.FromString,
            _registered_method=True,
        )
        self.UpdateTerm = channel.unary_unary(
            "/glossary.GlossaryService/UpdateTerm",
            request_serializer=glossary__pb2.TermUpdateRequest.SerializeToString,
            response_deserializer=glossary__pb2.TermResponse.FromString,
            _registered_method=True,
        )
...
def add_GlossaryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "ListTerms": grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=glossary__pb2.TermNames.SerializeToString,
        ),
        "GetTerm": grpc.unary_unary_rpc_method_handler(
            servicer.GetTerm,
            request_deserializer=glossary__pb2.TermNameRequest.FromString,
            response_serializer=glossary__pb2.TermResponse.SerializeToString,
        ),
        "CreateTerm": grpc.unary_unary_rpc_method_handler(
            servicer.CreateTerm,
            request_deserializer=glossary__pb2.TermCreateRequest.FromString,
            response_serializer=glossary__pb2.TermResponse.SerializeToString,
        ),
        "UpdateTerm": grpc.unary_unary_rpc_method_handler(
            servicer.UpdateTerm,
            request_deserializer=glossary__pb2.TermUpdateRequest.FromString,
            response_serializer=glossary__pb2.TermResponse.SerializeToString,
        ),
...
class GlossaryService(object):
    ...
    def ListTerms(
        ...
        return grpc.experimental.unary_unary(
            ...
            glossary__pb2.TermNames.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetTerm(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/glossary.GlossaryService/GetTerm",
            glossary__pb2.TermNameRequest.SerializeToString,
    ...
    def CreateTerm(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/glossary.GlossaryService/CreateTerm",
            glossary__pb2.TermCreateRequest.SerializeToString,
            glossary__pb2.TermResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def UpdateTerm(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/glossary.GlossaryService/UpdateTerm",
            glossary__pb2.TermUpdateRequest.SerializeToString,
            glossary__pb2.TermResponse.FromString,
            options,
            channel_credentials,
            insecure,
